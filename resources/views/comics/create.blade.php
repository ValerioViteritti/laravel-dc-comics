        ...
        <form class="py-5" action="{{ route('comics.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('thumb') is-invalid @enderror" id="thumb"
                    name="thumb"placeholder="Inserisci il Percorso immagine" value="{{ old('thumb') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('type') is-invalid @enderror" id="type"
                    name="type"placeholder="Inserisci il Tipo" value="{{ old('type') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('series') is-invalid @enderror" id="series"
                    name="series"placeholder="Inserisci la Serie" value="{{ old('series') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('sale_date') is-invalid @enderror" id="sale_date"
                    name="sale_date"placeholder="Inserisci la Data di Uscita" value="{{ old('sale_date') }}">
